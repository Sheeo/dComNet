...
Ved kørsel af \imul{} med $x=0$ og $y=0$, er anstallet af instruktioner der bliver udført $14$. Hvis man kører programmet med en hvilken som helst anden værdi af $y$, vil antallet af instruktioner være det samme.

Der kan ses et mønster, som kan beskrives ved følgende afhængighed:

\[
	i = 13x + 14
\]

Følgende er en tabel over antallet af instruktioner ved kørsel af imul med de angivne parametre:
...
Dette skyldes, at for hver gang x bliver en større, skal der udføres 13 ekstra instruktioner, for at addere x og y. Samt en basis-mængde af instruktioner, som udgør 14.
