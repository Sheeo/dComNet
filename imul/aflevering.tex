...
For hver gang x bliver en større, skal der udføres 13 ekstra instruktioner. Dette svarer til det antal instruktioner, som findes i \imul{}s \texttt{while} sektion.
