...
The program is simply a shell script that assembles the IJVM code and runs it,
passing the two arguments $x$ and $y$ from the command line. The trace output
is stored in a temporary file (in the folder \texttt{gen} designated for
generated files), and it's line count and return line are printed to the user.
